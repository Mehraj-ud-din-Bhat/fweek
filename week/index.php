...
<td class="quater">
 ...
 <td class="pdf">
    <a ng-If="Q.filename.length>0" href="admin/uploads/{{Q.filename}}" class="btn btn-danger">VIEW PDF</a>
                   <a ng-If="Q.ppt_name.length>0" href="admin/uploads/{{Q.ppt_name}}" class="btn btn-warning">VIEW PPT </a>
